define(['react', "jquery", "underscore", 
        "models/session", "models/book_title_list",  "models/book_owner_list", "models/comment_list", 
        "mixins/authority"],
function(React, $, _, 
         SessionManager, BookTitleListModel, BookOwnerListModel, CommentListModel, 
         AuthorityMixin){
  ...
  var BookTitle = React.createClass({
    ...
    refleshComment: function(){
      this.state.comments.fetchComments(this.props.bookTitle, 
        function(comments){
          this.setState({
            comments: comments
          });
        ...
        function(error){
           swal("書籍のコメントが取得できませんでいsた", "再度ブラウザをリロードしてください", "error");
        }.bind(this));
    },
          ...
          <td className="col-md-1">
            <div>
              <div className="btn-group">
                <button className="btn btn-info" data-toggle="modal" data-target={dataTarget}><span>{commentButtonTitle}</span></button>
              </div>
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      <CommentArea parent={this.props.bookTitle} comments={this.state.comments} refleshCallback={this.refleshComment} />
                    </div>
